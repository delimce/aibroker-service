...
@Test
    void login_withValidCredentials_returnsOkResponse() throws Throwable {
        ...
        when(
                accountLoginService.execute(any(UserLoginRequest.class))).thenReturn(serviceResponse);
...
@Test
    void login_whenUserIsNotActive_returnsUnauthorized() throws Throwable {
        ...
        when(
                accountLoginService.execute(any(UserLoginRequest.class))).thenThrow(new UserIsNotActiveException());
...
@Test
    void register_withValidPayload_returnsCreatedPayload() throws Throwable {
        ...
        when(
                accountRegisterService.execute(any(UserRegistrationRequest.class))).thenReturn(createdResponse);
...
@Test
    void register_whenIllegalArgumentThrown_returnsBadRequest()
        ...
        when(
                accountRegisterService.execute(any(UserRegistrationRequest.class))).thenThrow(
